...
const selectClass =
  "h-9 min-w-0 flex-1 rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring";
...
export function TimePicker({
  ...
  return (
    <div id={id} className={cn("flex items-center gap-2", className)}>
      ...
      <select
        aria-label="Minutes"
        className={cn(selectClass, "flex-none basis-20")}
        value={minute}
      ...
      <div
        className="flex shrink-0 overflow-hidden rounded-md border border-input shadow-sm"
        role="group"
        aria-label="AM or PM"
      >
